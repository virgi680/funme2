...
//                 	 correo.mandarCorreoCrearEvento(email, nombre, dia, hora);
    ...
    public @ResponseBody ResponseEntity<String> infoEvento(HttpServletResponse response, @RequestParam(value="nombre",required=false) String nombre, @RequestParam(value="lugar",required=false) String lugar) {
      
        MySQL my= new MySQL();
        String respuesta = my.obtener_info_Evento(nombre.toLowerCase(),lugar.toLowerCase());
        response.setHeader("Access-Control-Allow-Origin", "*");
	...
	@RequestMapping(value="/buscarEventos")
	   public ResponseEntity<String> buscarEventos(
	          ...
	          @RequestParam(value="email",required=false) String email){
	           ...
	           System.out.println("entra en buscar eventos");
	          MySQL my= new MySQL();
	          
	          response.setHeader("Access-Control-Allow-Origin", "*");  
	          String respuestaJson=my.buscarEventos(categoria.toLowerCase(),lugar.toLowerCase(),email.toLowerCase());
	          return new ResponseEntity<String>(respuestaJson, HttpStatus.OK);
	 }
